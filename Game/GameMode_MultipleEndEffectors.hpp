...
//----------------------------------------------------------------------------------------------------------------------
class GameMode_MultipleEndEffectors : public GameModeBase
{
public:
	GameMode_MultipleEndEffectors();
	virtual ~GameMode_MultipleEndEffectors();
	...
	void RenderCreature( std::vector<Vertex_PCU>& verts ) const;
...
public:
	...
	FingerTarget	  m_fingerTarget	= INDEX;
};
