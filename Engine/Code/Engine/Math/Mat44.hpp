...
// CreatedZRotationDegrees( float );
// Matt44 myRotationMatrix = Matt44::CreatedZRotationDegrees( m_orientationDegrees );
...
struct Mat44
{
	...
	Vec4 const		TransformHomogeneous3D( Vec4 const& position3D ) const;
	...
	void AppendXRotation( float degreesRotationAboutZ );
